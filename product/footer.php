					...
					<div class="row">
						...
						<div class="span4">
							...
							<ul class="more-info-nav">
								<li><i class="icon-circle-arrow-right"></i><a href="ribon.php">Ribbon</a></li>
								<li><i class="icon-circle-arrow-right"></i><a href="hook.php">Hook</a></li>
								<li><i class="icon-circle-arrow-right"></i><a href="#">All Product</a></li>
								<li><i class="icon-circle-arrow-right"></i><a href="button.php">Batton Image</a></li>
								<li><i class="icon-circle-arrow-right"></i><a href="photo_board.php">Photo Board</a></li>
						...
						<div class="span3">
							...
							<marquee scrollamount = "3" onmouseover = "this.stop();" onmouseout = "this.start();" direction="up" class="item-service">
								<ol class="item-nav">
									<li><a href="button.php">Batton</a></li>
									<li><a href="barcode_label.php">Oven label</a></li>
									<li><a href="care_lable.php">Printed Care Lable (Satin & Paper)</a></li>
									<li><a href="size_label.php">Printed Size Lable (Satin & Paper)</a></li>
									<li><a href="barcode_label.php">Printed Barcode Lable (Satin & Paper)</a></li>
									<li><a href="barcode_label.php">Printed Fabric Lable (Satin & Paper)</a></li>
									<li><a href="barcode_label.php">Printed Lacher Patch</a></li>
									<li><a href="barcode_label.php">Printed Price Tag </a></li>
									<li><a href="hang_tag.php">Printed Hang Tag</a></li>
									<li><a href="barcode_label.php">Printed Dicard window Boxes</a></li>
									<li><a href="barcode_label.php">Printed pocket Flashers</a></li>
									<li><a href="photo_board.php">Printed Photo Layer s</a></li>
									<li><a href="pricetag.php">Printed  Head Cards</a></li>
									<li><a href="pricetag.php">Printed Boxr Bands</a></li>
									<li><a href="sticker.php">Printed Barcode Stickers</a></li>
									<li><a href="sticker.php">Printed Poly Stickers</a></li>
									<li><a href="sticker.php">Printed Cartoon Stickers</a></li>
									<li><a href="twill_tape.php">Printed Twill Tape</a></li>
									<li><a href="twill_tape.php">Twill Tape</a></li>
									<li><a href="elastic.php">Elistic Bands</a></li>
									<li><a href="hook.php">Hook</a></li>
									<li><a href="laces.php">Laces</a></li>
									<li><a href="ribon.php">Ribbon</a></li>
									<li><a href="velvet.php">VelVel Tape</a></li>
								</ol> <!-- .item-nav  -->
							</marquee> 
						</div> <!-- .span3  -->
					</div> <!--  row -->
